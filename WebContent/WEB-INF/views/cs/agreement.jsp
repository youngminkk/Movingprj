...
<body class="mt-5">
 ...
 <jsp:include page="../includes/csnav.jsp"></jsp:include>
    <div class="mt-4"><h4>서비스 이용약관</h4></div>
            ...
            <div class="col-lg-8 card-body p-5">
              <div class="ps-lg-0-6 ps-xl-2">
                <div class="mb-5">
                    ...
                    제 1 장 총칙<br>
                    제 1 조 (목적)
                    본 약관은 (주)무빙(이하 “회사”라 합니다)이 운영하는 웹사이트 ‘무빙’ (www.moving.com) (이하 “웹사이트”라 합니다)에서 제공하는 온라인 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
                    </p>
                    <p class="text-wrap text-left">
                    제 2 조 (용어의 정의)
