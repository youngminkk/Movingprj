...
//		Board board = Board.builder().bcate(1L).userno(3L).title("테스트 중").content("테스트 중").build();
...
//		Board board = Board.builder().bno(51L).title("수정한제목").content("수정한내용").build();
//		
...
//		log.info(mapper.delete(4L) == true ? "삭제함" : "삭제할 게 없음");
//}
}