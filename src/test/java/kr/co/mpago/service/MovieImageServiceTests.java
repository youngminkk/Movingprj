...
public class MovieImageServiceTests {
	MovieImageService movieImageService = MovieImageService.getMovieImageService();
	...
	public void testgetMovieApiUrl() {
		...
		String apiurl = movieImageService.getMovieApiUrl(mno, apiKey);
		log.info(apiurl);
	}
	...
	public void testAddMovieImage() throws IOException {
		...
		movieImageService.addMovieDataFromJson(mno, apiKey, movieImageService.getMovieApiUrl(mno, apiKey));
		}
		
	}
	@Test
	public void test3() {
		List<Map<String, Object>> movieImages = movieImageService.getMovieGenreImg("poster");
		log.info(movieImages);
	}
