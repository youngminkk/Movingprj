...
@Log4j
public class MovieVideoServiceTests {
	MovieVideoService movieVideoService = MovieVideoService.getMovieVideoService();
	...
	public void testgetMovieApiUrl() {
		...
		String apiurl = movieVideoService.getMovieApiUrl(mno, apiKey);
		log.info(apiurl);
	}
	...
	public void testAddMovieImage() throws IOException {
		...
		movieVideoService.addMovieDataFromJson(mno, apiKey, movieVideoService.getMovieApiUrl(mno, apiKey));
